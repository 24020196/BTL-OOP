...
public class DatabaseConnection {
    ...
    /**
     * Biến kết nối tĩnh (Lưu ý: Thường không khuyến khích sử dụng biến tĩnh
     * cho kết nối trong môi trường đa luồng, nhưng có thể dùng trong
     * ứng dụng desktop đơn giản. Phương thức getConnection() bên dưới
     * hiện đang tạo kết nối mới mỗi lần gọi).
     */
