...
public class Login extends Application {
    ...
    /**
     * Lấy thể hiện (instance) Singleton của AudioController.
     * Dòng này (nếu là dòng 10) chính là nguyên nhân gây ra lỗi
     * 'ExceptionInInitializerError' -> 'NullPointerException'
     * mà bạn gặp ban đầu, do nó cố gắng tải tài nguyên âm thanh
     * quá sớm khi lớp Login đang được nạp.
     */
